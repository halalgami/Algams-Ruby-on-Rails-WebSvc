...
ActiveRecord::Schema.define(version: 20131231213937) do
  ...
  create_table "btc_gsm_sig_surv", primary_key: "trans_id", force: true do |t|
    ...
    t.datetime "audit_create_date",              default: '2013-12-31 22:15:05'
  ...
  create_table "custinvoices", primary_key: "invoicenum", force: true do |t|
    ...
    t.datetime "createdate",                                          default: '2013-12-31 22:15:05'
  end
